...
public class PolicyHandler {
    ...
    @StreamListener(
        ...
        condition = "headers['type']=='ReviewWritten'"
    )
    public void wheneverReviewWritten_IncreasePoint(
        @Payload ReviewWritten reviewWritten
    ) {
        ReviewWritten event = reviewWritten;
        System.out.println(
            "\n\n##### listener IncreasePoint : " + reviewWritten + "\n\n"
        );
